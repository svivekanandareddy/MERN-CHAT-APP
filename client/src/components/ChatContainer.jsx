    ...
    <div className="h-full overflow-scroll relative backdrop-blur-lg">
      ...
      <div className="flex flex-col h-[calc(100%-120px)] overflow-y-scroll p-3 pb-20">
        {messages.map((msg, index) => (
          <div
            key={index}
            className={`flex items-end gap-2 mb-8 justify-end ${
      ...
      <div className="absolute bottom-0 left-0 right-0 flex items-center gap-3 p-3 bg-black/20">
        <div className="flex-1 flex items-center bg-gray-100/12 px-3 rounded-full">
          <input
            ...
            className="flex-1 text-sm p-2 px-4 border-none rounded-lg outline-none text-white placeholder-gray-400 bg-white/10"
          />
